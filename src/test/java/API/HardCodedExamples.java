...
public class HardCodedExamples {
    ...
    String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2ODU0NTU0Nj" +
            "UsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTY4NTQ5ODY2NSwidXNlcklkIjoiNTQzNSJ9." +
            "vwmYkCszkE8j9_YgikzJFLxs6Lm-RTlMsqS-WksL2ZE";
    static String employee_id;
    static String emp_status;
    static String emp_job_title;
    ...
    public void acreateEmployee() {
        ...
        response.then().assertThat().body("Employee.emp_firstname", equalTo("AlexM"));
        response.then().assertThat().body("Employee.emp_lastname", equalTo("Minyshk"));
...
//        response.prettyPrint();
        response.then().assertThat().statusCode(200);
        emp_status = response.jsonPath().getString("Employee.emp_status");
        emp_job_title = response.jsonPath().getString("Employee.emp_job_title");
