...
public class APIPayloadConstants {
    ...
    public static String createEmployeePayloadJson() {
        ...
        obj.put("emp_firstname", "AlexM");
        obj.put("emp_lastname", "Minyshk");
        obj.put("emp_middle_name", "Nik");
        obj.put("emp_gender", "M");
        obj.put("emp_birthday", "1973-12-19");
